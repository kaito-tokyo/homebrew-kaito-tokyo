class KaitoTokyoOnnxruntimeAT1244 < Formula
  ...
  depends_on "kaito-tokyo-pybind11@3.0.3" => :build
  depends_on "nlohmann-json" => :build
  depends_on "safeint" => :build
  depends_on "abseil"
  depends_on "kaito-tokyo-numpy@2.4.4"
  depends_on "kaito-tokyo-onnx@1.20.1"
  depends_on "kaito-tokyo-python@3.11"
  depends_on "protobuf"
  depends_on "re2"
  ...
  def install
    ...
    system python3, "-m", "pip", "install", *std_pip_args(build_isolation: true), "build/Release"
  end
